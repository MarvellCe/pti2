...
const MapMedan = () => {
  ...
  const handleMedan = () => {
    ...
    alert("Darah anda bertambah menjadi 120!");
  ...
  return (
    <div>
      <div className='container-map'>
        ...
        <img src={pointer} alt="pointer2" className='pointer2' onClick={handleMedan} />
        <img src={kunci} alt="kunci2" className='kunci2 animate-bounce' onClick={handleKunci} />
