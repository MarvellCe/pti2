...
import makanan1 from "./gambar/makananMedan1.jpg";
import makanan2 from "./gambar/makananMedan2.jpg";
import makanan3 from "./gambar/makananMedan3.jpg";
...
const Restoran = () => {
  ...
  const handleMedan = () => {
    navigate("/medan", {
      state: { name: name, character: character, health: health, money: money, weather: weather, weatherId: weatherId, makananMedan1: makananMedan1, makananMedan2:makananMedan2, makananMedan3:makananMedan3},
    });
  };
      ...
      <div className="content">
        ...
        <div className="flex justify-around m-4">
          <div className="grid place-items-center">
            <h3>Jumlah yang dimiliki : {makananMedan1}</h3>
          ...
          <div className="grid place-items-center">
            <h3>Jumlah yang dimiliki : {makananMedan2}</h3>
          ...
          <div className="grid place-items-center">
            <h3>Jumlah yang dimiliki : {makananMedan3}</h3>
        ...
        <button onClick={handleMedan}>Back to Home</button>
      </div>
    </div>
  );
};
