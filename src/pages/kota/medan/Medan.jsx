...
const Medan = () => {
  ...
  const handleResto = () => {
    navigate("/restoranMedan", {state: { name: name, character: character, health: health, money: money, weather: weather, weatherId: weatherId, makananMedan1: makananMedan1, makananMedan2:makananMedan2, makananMedan3:makananMedan3} });
  };

  const handleMuseum = () => {
    navigate("/museumMedan", {state: { name: name, character: character, health: health, money: money, weather: weather, weatherId: weatherId,makananMedan1: makananMedan1, makananMedan2:makananMedan2, makananMedan3:makananMedan3} });
  };
    ...
    <div>
      ...
      <div className="bg-blue-200">
        ...
        <div className="flex p-1">
          <h2 className="bg-red-100 w-32 p-2 text-center">HEALTH : {health}/120</h2>
