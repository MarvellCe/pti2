...
const Pekanbaru = () => {
  ...
  const handleResto = () => {
    navigate("/restoranpekanbaru", {state: { name: name, character: character, health: health, money: money, weather: weather, weatherId: weatherId,makananPekanbaru1: makananPekanbaru1, makananPekanbaru2:makananPekanbaru2, makananPekanbaru3:makananPekanbaru3} });
  };

  const handleMuseum = () => {
    navigate("/museumpekanbaru", {state: { name: name, character: character, health: health, money: money, weather: weather, weatherId: weatherId,makananPekanbaru1: makananPekanbaru1, makananPekanbaru2:makananPekanbaru2, makananPekanbaru3:makananPekanbaru3} });
  };
    ...
    <div>
      ...
      <div className="bg-blue-200">
        ...
        <div className="flex p-1">
          <h2 className="bg-red-100 w-32 p-2 text-center">HEALTH : {health}/140</h2>
