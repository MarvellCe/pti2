...
const Bangka = () => {
  ...
  const handleResto = () => {
    navigate("/restoranBangka", {state: { name: name, character: character, health: health, money: money, weather: weather, weatherId: weatherId,makananBangka1: makananBangka1, makananBangka2:makananBangka2, makananBangka3:makananBangka3} });
  };

  const handleMuseum = () => {
    navigate("/museumBangka", {state: { name: name, character: character, health: health, money: money, weather: weather, weatherId: weatherId,makananBangka1: makananBangka1, makananBangka2:makananBangka2, makananBangka3:makananBangka3} });
  };
    ...
    <div>
      ...
      <div className="bg-blue-200">
        ...
        <div className="flex p-1">
          <h2 className="bg-red-100 w-32 p-2 text-center">HEALTH : {health}/200</h2>
